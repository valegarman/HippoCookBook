...
createProbe('excel_file','electrodes_coordinates_Tetrodes-32ch(8t-4c)-C57-5');

% FL4_080322_sess1
bpath = 'D:\FLR\FL4\FL4_080322_sess1';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',27,'SWChannel',32,'thetaChannel',27);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');
...
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',27,'SWChannel',32,'thetaChannel',27);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');
...
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',18,'SWChannel',4,'thetaChannel',18);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');
...
% FL5_230322_sess1
bpath = 'D:\FLR\FL5\FL5_230322_sess1';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_240322_sess2
bpath = 'D:\FLR\FL5\FL5_240322_sess2';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_250322_sess3
bpath = 'D:\FLR\FL5\FL5_250322_sess3';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_260322_sess4
bpath = 'D:\FLR\FL5\FL5_260322_sess4';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_270322_sess5
bpath = 'D:\FLR\FL5\FL5_280322_sess5';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_290322_sess6
bpath = 'D:\FLR\FL5\FL5_290322_sess6';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_300322_sess7
bpath = 'D:\FLR\FL5\FL5_300322_sess7';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'SWChannel',19,'thetaChannel',17);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');

% FL5_310322_sess8
bpath = 'D:\FLR\FL5\FL5_310322_sess8';
processSession_pablo('basepath',bpath,'project','SocialProject','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',19,'SWChannel',19,'thetaChannel',19);
indexNewSession_pablo('basepath',bpath,'project','SocialProject');
...
bpath = 'D:\fSUB1\fSUB1_021222_sess17';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'thetaChannel',17,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true);
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');
...
% fSUB1_100223_sess32
bpath = 'D:\fSUB1\fSUB1_100223_sess32';
processSession_pablo('basepath',bpath,'promt_hippo_layers',false,'anymaze_ttl_channel',2,'rippleChannel',43,'thetaChannel',43,'tint',true,'speedThresh',1,'gridAnalysis',false,'randomization',true);
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB1_110223_sess33 (Open Field)
bpath = 'D:\fSUB1\fSUB1_110223_sess33';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',22,'thetaChannel',22,'tint',true,'speedThresh',1,'gridAnalysis',false,'randomization',true);
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB1_120223_sess34 (Open Field)
bpath = 'D:\fSUB1\fSUB1_120223_sess34';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'thetaChannel',17,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true);
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB1_130223_sess35 (Open Field)
bpath = 'D:\fSUB1\fSUB1_130223_sess35';
...
% fSUB1_140223_sess36 (Open Field)
bpath = 'D:\fSUB1\fSUB1_140223_sess36';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',17,'thetaChannel',17,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true);
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');
...
bpath = 'D:\fSUB2\fSUB2_110223_sess3';
...
% fSUB2_130223_sess4 (Open Field)
bpath = 'D:\fSUB2\fSUB2_130223_sess4';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',11,'SWChannel',17,'thetaChannel',11,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true,'excludeAnalysis',{'subSessionsAnalysis'});
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB2_140223_sess5
bpath = 'D:\fSUB2\fSUB2_140223_sess5';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',11,'SWChannel',17,'thetaChannel',11,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true,'excludeAnalysis',{'subSessionsAnalysis'});
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB2_150223_sess6
bpath = 'D:\fSUB2\fSUB2_150223_sess6';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',11,'SWChannel',17,'thetaChannel',11,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true,'excludeAnalysis',{'subSessionsAnalysis'});
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB2_160223_sess7
bpath = 'D:\fSUB2\fSUB2_160223_sess7';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',11,'SWChannel',17,'thetaChannel',11,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true,'excludeAnalysis',{'subSessionsAnalysis'});
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');

% fSUB2_170223_sess8
bpath = 'D:\fSUB2\fSUB2_170223_sess8';
processSession_pablo('basepath',bpath,'promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',11,'SWChannel',17,'thetaChannel',11,'tint',true,'speedThresh',0,'gridAnalysis',false,'randomization',true,'excludeAnalysis',{'subSessionsAnalysis'});
indexNewSession_pablo('basepath',bpath,'project','SubiculumProject');
...
processSession_pablo('basepath',bpath,'project','MK801Project','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',37,'SWChannel',13,'thetaChannel',37);
indexNewSession_pablo('basepath',bpath,'project','MK801Project');
...
processSession_pablo('basepath',bpath,'project','MK801Project','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',42,'SWChannel',17,'thetaChannel',42);
indexNewSession_pablo('basepath',bpath,'project','MK801Project');
...
% IPO431_221021_sess1 MK801
bpath = 'F:\data\IPO431\IPO431_221021_sess1'; 
processSession_pablo('basepath',bpath,'project','MK801Project','promt_hippo_layers',true,'anymaze_ttl_channel',2,'rippleChannel',2,'SWChannel',[],'thetaChannel',2);
indexNewSession_pablo('basepath',bpath,'project','MK801Project');
...
% fVIP1_220525_sess11
bpath = 'J:\data\fVIP1\fVIP1_220525_sess11'; 
processSession('basepath',bpath);
indexNewSession('basepath',bpath,'copyFiles',false);
