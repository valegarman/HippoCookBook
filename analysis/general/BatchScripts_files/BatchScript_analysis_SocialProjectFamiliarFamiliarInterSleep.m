%% BatchScript_analysis_SocialProjectNovelFamiliarInterSleep
...
sessionsTable = readtable(['C:\Users\Jorge\Documents\GitHub\SocialProject',filesep,'indexedSessions_SocialProjectFamiliarFamiliar.csv']);
forceReload = false;
...
for ii = 1:length(sessionsTable.SessionName)
    if strcmpi(sessionsTable.Project{ii}, targetProject) || strcmpi('all', targetProject)
        ...
        for jj = 1:length(session.epochs)
           ...
           if strcmpi(session.epochs{jj}.behavioralParadigm,'InterSleep1') | strcmpi(session.epochs{jj}.behavioralParadigm,'InterSleep2')
...
%         mkdir('Epochs');
%         saveas(gca,['Epochs\plotRippleChannel_PostSleepFamiliar.png']);
% 
...
%         save([session.general.name,'.ripples_PostSleepFamiliar.events.mat'],'ripples');
...
%         mkdir('Epochs');
% 
%         saveas(gca,['Epochs\spikesPsthRate_ripples_PostSleepFamiliar.png']);
% 
%         raster = psthRipples_epoch.raster;
%         psth = rmfield(psthRipples_epoch,'raster');
% 
%         save([session.general.name,'.ripples_PostSleepFamiliar.cellinfo.mat'],'psth','-v7.3');
%         save([session.general.name,'.ripples_PostSleepFamiliar_raster.cellinfo.mat'],'raster','-v7.3');
        ...
        save([session.general.name,'.averageCCG_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCG_PostSleepFamiliar.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverage_PostSleepFamiliar.png']);
        ...
        save([session.general.name,'.averageCCG_CA3_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA3_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA2_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA2_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
       ...
       if ~isempty(dir(['*ripples_',session.epochs{jj}.behavioralParadigm,'.events.mat']))
        ...
        averageCCG = averageCCG_epoch;
        save([session.general.name,'.averageCCGNoRipples_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCGNoRipples_PostSleepFamiliar.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverageNoRipples_PostSleepFamiliar.png']);
        ...
        save([session.general.name,'.averageCCGNoRipples_CA3_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA3_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA2_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA2_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
       ...
       if ~isempty(dir(['*ripples_',session.epochs{jj}.behavioralParadigm,'.events.mat']))
        ...
        averageCCG = averageCCG_epoch;
        save([session.general.name,'.averageCCGNoRipplesNoTheta_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCGNoRipplesNoTheta_PostSleepFamiliar.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverageNoRipplesNoTheta_PostSleepFamiliar.png']);
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA3_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA3_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA2_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA2_pyr_PostSleepFamiliar.cellinfo.mat'],'averageCCG');
...
%         save([session.general.name,'.cell_metrics_PostSleepFamiliar.cellinfo.mat'],'cell_metrics');
