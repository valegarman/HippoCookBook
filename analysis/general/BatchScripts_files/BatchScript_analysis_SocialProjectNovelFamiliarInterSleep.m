...
sessionsTable = readtable(['C:\Users\Jorge\Documents\GitHub\SocialProject',filesep,'indexedSessions_SocialProjectNovelFamiliar.csv']);
forceReload = false;
...
%         mkdir('Epochs');
%         saveas(gca,['Epochs\plotRippleChannel_PostSleepNovel.png']);
% 
...
%         save([session.general.name,'.ripples_PostSleepNovel.events.mat'],'ripples');
...
%         mkdir('Epochs');
% 
%         saveas(gca,['Epochs\spikesPsthRate_ripples_PostSleepNovel.png']);
% 
%         raster = psthRipples_epoch.raster;
%         psth = rmfield(psthRipples_epoch,'raster');
% 
%         save([session.general.name,'.ripples_PostSleepNovel.cellinfo.mat'],'psth','-v7.3');
%         save([session.general.name,'.ripples_PostSleepNovel_raster.cellinfo.mat'],'raster','-v7.3');
        ...
        save([session.general.name,'.averageCCG_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCG_PostSleepNovel.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverage_PostSleepNovel.png']);
        ...
        save([session.general.name,'.averageCCG_CA3_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA3_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA2_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCG_CA2_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
       ...
       if ~isempty(dir(['*ripples_',session.epochs{jj}.behavioralParadigm,'.events.mat']))
        ...
        averageCCG = averageCCG_epoch;
        save([session.general.name,'.averageCCGNoRipples_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCGNoRipples_PostSleepNovel.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverageNoRipples_PostSleepNovel.png']);
        ...
        save([session.general.name,'.averageCCGNoRipples_CA3_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA3_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA2_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipples_CA2_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
       ...
       if ~isempty(dir(['*ripples_',session.epochs{jj}.behavioralParadigm,'.events.mat']))
        ...
        averageCCG = averageCCG_epoch;
        save([session.general.name,'.averageCCGNoRipplesNoTheta_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        saveas(gca,['Epochs\allCellsAverageCCGNoRipplesNoTheta_PostSleepNovel.png']);
        ...
        saveas(gca,['Epochs\grandCCGAverageNoRipplesNoTheta_PostSleepNovel.png']);
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA3_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA3_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA2_PostSleepNovel.cellinfo.mat'],'averageCCG');
        ...
        save([session.general.name,'.averageCCGNoRipplesNoTheta_CA2_pyr_PostSleepNovel.cellinfo.mat'],'averageCCG');
...
%         save([session.general.name,'.cell_metrics_PostSleepNovel.cellinfo.mat'],'cell_metrics');
