...
list_of_sessions = {'Y:\camk12\camk12_250507_sess5', 'Y:\camk14\camk14_251010_sess9', 'Y:\camk14\camk14_251013_sess10',...
    'Y:\camk14\camk14_251014_sess11', 'Y:\camk14\camk14_251017_sess13'};
...
for ii = 1:length(list_of_paths)
        ...
        try
            ...
            uLEDPulses = getuLEDPulses('force',false, 'saveMat', false);
            uLEDPulses_pairs = getuLEDPulsePairs(uLEDPulses, ...
                'MaxIPI', 0.040);
            spikes = loadSpikes;
            uLEDPairResponses = getuLEDPairResponses(spikes, uLEDPulses_pairs);
            clear uLEDPulses uLEDPulses_pairs spikes uLEDPairResponses
