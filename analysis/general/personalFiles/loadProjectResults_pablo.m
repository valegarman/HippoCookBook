...
% average CCG per subSession
try projectResults.averageCCGSubSession = stackSessionResult(projectSessionResults.averageCCGSubSession, projectSessionResults.numcells);
catch
    warning('averageCCG was not staked!');
end
