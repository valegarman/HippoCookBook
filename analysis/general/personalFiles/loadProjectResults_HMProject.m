function [projectResults, projectSessionResults] =  loadProjectResults_HMProject(varargin)
...
for ii = 1:length(sessions.basepaths)
    ...
    % ACG PreEyesClosed
    targetFile = dir('*.averageCCG_PreEyesClosed.cellinfo.mat'); 
    
    load(targetFile.name);
    projectSessionResults.averageCCG_PreEyesClosed{ii} = averageCCG;
    clear averageCCG
    
    % ACG PreEyesOpen
    targetFile = dir('*.averageCCG_PreEyesOpen.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.averageCCG_PreEyesOpen{ii} = averageCCG;
    clear averageCCG
    ...
    targetFile = dir('*theta_6-12_PreEyesClosed.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.thetaModulation_PreEyesClosed{ii} = thetaMod;
    clear thetaMod
    
    targetFile = dir('*theta_6-12_PreEyesOpen.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.thetaModulation_PreEyesOpen{ii} = thetaMod;
    clear thetaMod
    ...
    targetFile = dir('*theta_6-12_Post.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.thetaModulation_Post{ii} = thetaMod;
    clear thetaMod
    ...
    targetFile = dir('*.lgamma_20-60_PreEyesClosed.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.lGammaModulation_PreEyesClosed{ii} = lgammaMod;
    clear lgammaMod
    
    targetFile = dir('*.lgamma_20-60_PreEyesOpen.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.lGammaModulation_PreEyesOpen{ii} = lgammaMod;
    clear lgammaMod
...
%     clear lgammaMod
    ...
    targetFile = dir('*.hgamma_60-100_PreEyesClosed.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.hGammaModulation_PreEyesClosed{ii} = hgammaMod;
    clear hgammaMod
    
    targetFile = dir('*.hgamma_60-100_PreEyesOpen.PhaseLockingData.cellinfo.mat'); load(targetFile.name);
    projectSessionResults.hGammaModulation_PreEyesOpen{ii} = hgammaMod;
    clear hgammaMod
