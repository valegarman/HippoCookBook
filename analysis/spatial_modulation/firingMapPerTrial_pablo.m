function [firingTrialsMap] = firingMapPerTrial_pablo(varargin)
...
% firingTrialsMap
%
% Pablo Abad. Based on firingMapPerTrial by Manu-BuzsakiLab 2021
...
% Remove non-linearized conditions

for ii = 1:length(positions)
    indexToRemove(ii) = size(positions{ii},2) == 3;
end
positions{find(indexToRemove)} = [];
