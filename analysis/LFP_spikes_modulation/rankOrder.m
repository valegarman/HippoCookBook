...
% [rankStats] = RankOrder()
%  Get rank order stats of spikes inside events from previously calculated 
% getSpikesRank structure. The 'corrEvents' output field structure shows
...
if strcmpi(templateType,'Peak') || strcmpi(templateType,'CenterofMass')
    % External template
