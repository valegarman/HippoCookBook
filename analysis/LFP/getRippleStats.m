function [maps,data,stats] = getRippleStats(varargin)
...
%     'ripples'     By default tries to load ripple.event.mat structure.
%                       Otherwise, ripple timing information (see
%                       findRipples)
...
addParameter(p,'duration',[6 12], @isnumeric);
addParameter(p,'ripples',[20 100], @isstruct);
