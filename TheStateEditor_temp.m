...
%% Modified by Pablo Abad for HippoCookBook format :  1-index and removed sessionInfo dependencies

function TheStateEditor_temp(baseName, inputData, supressGUI, makePortable)
...
%             eeg1 = bz_GetLFP(Chs,'basepath',FO.basePath,'noPrompts',true);
            eeg1 = getLFP(Chs,'basepath',FO.basePath,'noPrompts',true);
