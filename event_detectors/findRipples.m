...
%     'basepath'    Path to a single session to run findRipples, default
%                       pwd
%    =========================================================================
%
% OUTPUT
...
% Manu Valero 2022 (adapt to 1-index, remove sessionInfo dependency and update inputs)
%
