...
% - for intan type recordings. This function is bz_ConcatenateDats from
% buzcode, but without sessionInfo dependency.
% 
...
%
%
% Copyright (C) 2017 by Brendon Watson (bz_ConcatenateDats)
% Modified by Antonio FR, 2018
% Modified by Manu Valero, 2022 (remove sessionInfo dependency)
...
try 
    ...
    disp('No . in top folder, trying subfolders')
