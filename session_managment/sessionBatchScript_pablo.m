...
batch_preprocessSession('basepath','C:\data\fCck3','cleanArtifacts',({[],1}),'analogChannelsList',[],'digitalChannelsList',1);
batch_sessionSummary('basepath','C:\data\fCck3','analogChannelsList',0,'digitalChannelsList',1);
preprocessSession('basepath','C:\data\fCck3\fCck3_220218_sess1','cleanArtifacts',({[],1}),'analogChannelsList',[],'digitalChannelsList',1);
