...
% analysis.
rippleChannel = [2]; %check it from file.dat and from hippocmpallayer
SWChannel = [32]; %check it from file.dat and from hippocmpallayer
...
eventSpikeThreshold = 0.5; % this is related to the big neuron generated by the activity of all neurons detected
