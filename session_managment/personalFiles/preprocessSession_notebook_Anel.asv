...
processSession('basepath','C:\app2\app2_250417_sess14','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);

indexNewSession('basepath','C:\app2\app2_250417_sess14');
