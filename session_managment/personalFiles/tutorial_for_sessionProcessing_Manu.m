...
processSession('digital_optogenetic_channels',0,'analog_optogenetic_channels',65,'promt_hippo_layers',true,'profileType','hippocampus','manual_analog_pulses_threshold',true);
