...
processSession('digital_optogenetic_channels',1,'analog_optogenetic_channels',[],'promt_hippo_layers',true,'manual_analog_pulses_threshold',true,'profileType','hippocampus');
