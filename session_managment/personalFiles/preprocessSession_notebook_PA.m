%% cancer10
updateExpFolder_temp({'E:\cancer10'},'D:\cancer10');

preprocessSession('basepath','D:\cancer10\cancer10_260514_sess1','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);


%% cancer11
updateExpFolder_temp({'E:\cancer11'},'D:\cancer11');

preprocessSession('basepath','D:\cancer11\cancer11_260514_sess1','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
...
processSession('basepath','Z:\unindexedSubjects\asso1\asso1_260408_sess3','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
...
indexNewSession('basepath','Z:\asso1\asso1_260402_sess1');
...
indexNewSession('basepath','Z:\unindexedSubjects\asso1\asso1_260421_sess5');
indexNewSession('basepath','Z:\unindexedSubjects\asso1\asso1_260422_sess6');
indexNewSession('basepath','Z:\unindexedSubjects\asso1\asso1_260423_sess7');
indexNewSession('basepath','Z:\unindexedSubjects\asso1\asso1_260424_sess8');
...
preprocessSession('basepath','D:\cancer8\cancer8_260311_sess8','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\cancer8\cancer8_260313_sess10','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

%% cancer9
updateExpFolder_temp({'E:\Crabcer\cancer9'},'D:\cancer9');

preprocessSession('basepath','D:\cancer9\cancer9_260308_sess5','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\cancer9\cancer9_260309_sess6','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\cancer9\cancer9_260307_sess4','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

%% fCamk7
preprocessSession('basepath','W:\unindexedSubjects\fCamk7\fCamk7_220425_sess19','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

processSession('basepath','C:\data\fCamk7\fCamk7_220426_sess20','digital_optogenetic_channels',[1 2],'analog_optogenetic_channels',[],'promt_hippo_layers',true);

%% fCck4
preprocessSession('basepath','C:\data\fCck4\fCck4_220310_sess3','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

processSession('basepath','C:\data\fCck4\fCck4_220307_sess2','digital_optogenetic_channels',[1],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\fCck4\fCck4_220310_sess3','digital_optogenetic_channels',[1],'analog_optogenetic_channels',[],'promt_hippo_layers',true);

%% TRAUMA1
updateExpFolder_temp({'E:\Trauma1'},'D:\trauma1');

preprocessSession('basepath','X:\unindexedSubjects\trauma1\trauma1_251223_sess21','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251217_sess15','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251218_sess16','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251219_sess17','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251220_sess18','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251221_sess19','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251222_sess20','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','W:\unindexedSubjects\trauma1\trauma1_251223_sess21','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

preprocessSession('basepath','D:\trauma1\trauma1_251214_sess12','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260211_sess22','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260213_sess23','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260216_sess24','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260217_sess25','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260223_sess29','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\trauma1\trauma1_260224_sess30','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

%% WT10
updateExpFolder_temp({'E:\wt10'},'D:\wt10');

preprocessSession('basepath','C:\data\wt10\wt10_251127_sess22','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[6]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\wt10\wt10_260118_sess37','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

processSession('basepath','C:\data\wt10\wt10_251030_sess4','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251117_sess15','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251106_sess9','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251118_sess16','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251114_sess14','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251120_sess17','digital_optogenetic_channels',[6],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251111_sess11','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251110_sess10','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251201_sess24','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\wt10\wt10_251209_sess27','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
...
preprocessSession('basepath','D:\wt9\wt9_251027_sess15','cleanArtifacts',({[],[6]}),'analysisPath',[],'exclude_shanks',[],'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

preprocessSession('basepath','C:\data\wt9\wt9_251110_sess25','cleanArtifacts',({[],[]}),'analysisPath',[],'exclude_shanks',[],'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\wt9\wt9_251118_sess33','cleanArtifacts',({[],[]}),'analysisPath',[],'exclude_shanks',[],'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\wt9\wt9_251120_sess35','cleanArtifacts',({[],[]}),'analysisPath',[],'exclude_shanks',[],'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
...
processSession('basepath','C:\data\wt9\wt9_251029_sess17','digital_optogenetic_channels',[6],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
...
processSession('basepath','Y:\cancer4\cancer4_250716_sess1','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','Y:\cancer4\cancer4_250717_sess2','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','Y:\cancer4\cancer4_250718_sess3','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','Y:\cancer4\cancer4_250722_sess7','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
...
processSession('basepath','C:\data\cancer2\cancer2_250706_sess5','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\cancer2\cancer2_250707_sess6','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);

indexNewSession('basepath','C:\data\cancer2\cancer2_250708_sess7');
indexNewSession('basepath','Y:\cancer2\cancer2_250710_sess9');
indexNewSession('basepath','C:\data\cancer2\cancer2_250706_sess5');
indexNewSession('basepath','C:\data\cancer2\cancer2_250707_sess6');
...
processSession('basepath','C:\data\cancer3\cancer3_250706_sess5','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\cancer3\cancer3_250707_sess6','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\cancer3\cancer3_250705_sess4','digital_optogenetic_channels',[],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
...
indexNewSession('basepath','C:\data\cancer3\cancer3_250706_sess5');
indexNewSession('basepath','C:\data\cancer3\cancer3_250707_sess6');
indexNewSession('basepath','C:\data\cancer3\cancer3_250705_sess4');
...
batch_preprocessSession('basepath','D:\F4CTL','medianSubstr',false,'exclude_shanks',5);


batch_preprocessSession('basepath','D:\M2KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\M3CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\F4CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\F2KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\M1KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\M4CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','D:\M1CTL','medianSubstr',false,'exclude_shanks',5);


batch_preprocessSession('basepath','E:\M3KANORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F3CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F2CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F1KANORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F1CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M3CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F4CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F2KANORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M2KANORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M1KANORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M2CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M1CTLNORT','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M222','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F6CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F20','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F5KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F4KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F3CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F2CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F1KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F1CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M3KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M5KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F5CTL','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\M4KA','medianSubstr',false,'exclude_shanks',5);
batch_preprocessSession('basepath','E:\F3KA','medianSubstr',false,'exclude_shanks',5);
...
%% CCK3
processSession('basepath','C:\data\fCck3\fCck3_220222_sess3','digital_optogenetic_channels',[1],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\fCck3\fCck3_220224_sess5','digital_optogenetic_channels',[1],'analog_optogenetic_channels',[],'promt_hippo_layers',true);

indexNewSession('basepath','C:\data\fCck3\fCck3_220222_sess3');
indexNewSession('basepath','C:\data\fCck3\fCck3_220224_sess5');
...
preprocessSession('basepath','D:\camk15\camk15_251124_sess2','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[1 2]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);
preprocessSession('basepath','D:\camk15\camk15_251126_sess3','analysisPath',[],'exclude_shanks',[],'cleanArtifacts',({[],[1 2]}),'analogChannelsList',[],'digitalChannelsList',[],'sessionSummary',false,'getPos',false);

processSession('basepath','C:\data\camk15\camk15_251121_sess1','digital_optogenetic_channels',[1 2],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\camk15\camk15_251124_sess2','digital_optogenetic_channels',[1 2],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
processSession('basepath','C:\data\camk15\camk15_251126_sess3','digital_optogenetic_channels',[1 2],'analog_optogenetic_channels',[],'promt_hippo_layers',true);
