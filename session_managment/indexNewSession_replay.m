function [] = indexNewSession_replay(varargin)
...
%% Winnie Yang created to incorporated analysis replated to reply, May 2022
% 1. ripple HSE = ripple start and end defiend by population burst time
...
% 8.2 Ripples
ripples = rippleMasterDetector_RSE('SWChannel',SWChannel,'rippleChannel',rippleChannel,'force',true, 'compute_RSE',true);
