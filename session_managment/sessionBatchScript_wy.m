...
basepath = 'J:\fCamk7_220425_sess19'
basepath = 'J:\fCamk7_220426_sess20'
%%

preprocessSession('basepath',pwd,'cleanArtifacts',({[],[1 2 6]}),'analogChannelsList',[],'digitalChannelsList',[1 2 6],'bazler_ttl_channel',10,'getPos',true);
