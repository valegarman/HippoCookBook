        ...
        function this=SuhRunUmap(nArgOut, varargin)
            ...
            function name=nameTheRegion
                ...
                if isempty(roi)
                    ...
                    if ~isempty(names)
                        ...
                        name=LabelLegendRoi.Rename(roiMap, roi, names{1}, tip);
                    else
                        ...
                        name=LabelLegendRoi.Rename(roiMap, roi, name);
                    end
                end
            end
            ...
            function ok=concludeDbm(makePolygon)
                ...
                elseif isempty(dbmROI)
                    msgError('No cluster picked!', 5, 'east+');
                    return;
                end
                dbmROI=[];
                if ~isempty(args.save_roi)
